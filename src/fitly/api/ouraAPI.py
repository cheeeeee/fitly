...
def insert_readiness_data(df_readiness_summary, days_back=7):
    ...
    df_readiness_summary.to_sql('oura_readiness_summary', engine, if_exists='append', index=True, method='multi', chunksize=19)
...
def insert_activity_data(df_activity_summary, df_activity_samples, days_back=7):
    ...
    try:
        df_activity_summary.to_sql('oura_activity_summary', engine, if_exists='append', index=True, method='multi', chunksize=19)
    ...
    try:
        df_activity_samples.to_sql('oura_activity_samples', engine, if_exists='append', index=True, method='multi', chunksize=19)
...
def insert_sleep_data(df_sleep_summary, df_sleep_samples, days_back=7):
    ...
    try:
        df_sleep_summary.to_sql('oura_sleep_summary', engine, if_exists='append', index=True, method='multi', chunksize=19)
    ...
    try:
        df_sleep_samples.to_sql('oura_sleep_samples', engine, if_exists='append', index=True, method='multi', chunksize=19)
